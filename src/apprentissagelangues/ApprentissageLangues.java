...
public class ApprentissageLangues extends Application {
    ...
    // on affiche l'interface de creation de compte
    public void showCreationCompte() throws IOException {
        primaryStage.close();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(ApprentissageLangues.class.getResource("view/creationDeCompte/creationDeCompte.fxml"));
        ...
        CreationDeCompteController controller = loader.getController();

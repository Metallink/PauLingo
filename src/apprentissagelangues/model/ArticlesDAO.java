...
public class ArticlesDAO {
    ...
    public boolean chargeAllArticles() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        try {
            ...
            e.printStackTrace();
            return false; // n'a pas réussi à charger la table ARTICLES, alors cette dernière n'existe pas: on va la créer/charger avec les fonctions suivantes. 
        }
    }
